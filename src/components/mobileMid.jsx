  ...
  return (
    <div className="relative w-full h-full">
      ...
      <div className="absolute h-[19.5%] w-[53.09%] top-[21.77%] right-[21.16%] bottom-[58.74%] left-[25.76%] text-left text-[31.07px] font-barlow">
        <img
          className="absolute h-full w-[99.84%] top-[0%] right-[0.16%] bottom-[0%] left-[0%] max-w-full overflow-hidden max-h-full"
          alt=""
          src="/group-37337.svg"
        />
        <div className="absolute h-full w-[99.91%] top-[0%] right-[0%] bottom-[0%] left-[0.09%]">
          <div className="absolute h-[28.17%] w-[22.52%] top-[68.81%] right-[0.01%] bottom-[3.02%] left-[77.48%]">
      ...
      >
        <div className="w-[99px] relative h-[23px]">
          <div className="absolute top-[0px] left-[0px] font-medium">
            Register Now
          </div>
        </div>
      </div>
      <div className="absolute top-[596px] left-[calc(50%_-_187.95px)] w-[404.4px] h-14 text-2xl-2 font-plus-jakarta-sans">
        <div className="absolute top-[0px] left-[calc(50%_-_202.2px)] w-[404.4px] h-14 flex flex-row items-center justify-center gap-2.5">
          ...
          <div className="flex flex-col items-start justify-start text-left">
            <div className="self-stretch relative leading-[27.14px] font-semibold text-transparent !bg-clip-text [background:linear-gradient(90deg,_#19fb9b,_#128881_59.5%,_#076e68)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">
              36 Hours
            </div>
            <div className="self-stretch relative text-4xs-9 tracking-[0.05em] leading-[13.57px] text-center">
              Possibilities
            </div>
          </div>
        </div>
