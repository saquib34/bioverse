  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-custom-gradient px-4 sm:px-6 md:px-8 lg:px-10">
      ...
      <div className="relative z-10 p-6 sm:p-8 md:p-10 lg:p-12 bg-gray-300 bg-opacity-40 backdrop-blur-xs border border-gray-200 shadow-md rounded-3xl max-w-4xl w-full">
        ...
        <p className="font-semibold mb-4 text-center sm:text-left">Please provide information about your project.</p>
        <form onSubmit={handleSubmit}>
          <div className="flex flex-col space-y-4">
            ...
            <textarea
              ...
              required
              className="flex-1 h-[110px] p-3 border placeholder-gray-900 placeholder:text-sm placeholder:font-semibold bg-gray-300 bg-opacity-40 backdrop-blur-xs rounded-3xl resize-none"
            />
          </div>
