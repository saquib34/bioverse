    ...
    return (
        ...
        <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[7.4%] left-[0%] text-xl">
            ...
            <div className="absolute top-[1060.99px] left-[calc(50%_-_677.16px)] tracking-[-0.03em] leading-[120%] inline-block w-[1354.3px]">
              "Join Us for an Epic Biohacking Journey! Collaborate with
              Pioneers, Push the Boundaries of Science, and Shape the Future of
          ...
          <div className="absolute top-[1696.99px] left-[619.32px] w-[1028.4px] h-[178.5px] font-plus-jakarta-sans">
